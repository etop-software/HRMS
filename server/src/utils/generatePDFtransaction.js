...
const generatePDFtransaction = (res, data,startDate,endDate, companyName, LoggedUser) => {
  ...
  const addMainHeader = () => {
    doc.fillColor(styles.headerColor)
      ...
      .text(`${companyName} Transaction Report`, { align: 'center' })
      .moveDown(0.3);
...
module.exports = generatePDFtransaction;